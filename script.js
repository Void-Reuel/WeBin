...
function scrollFunction() {
    if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
        ...
        document.getElementById("sezioni").style.width = "100%";
        document.getElementById("sezioni").style.marginLeft = "0";
        document.getElementById("sezioni").style.padding = "10px 0";
    } else {
        document.getElementById("title").style.backgroundColor = "#303134";
        document.getElementById("title").style.width = "96%";
        document.getElementById("title").style.marginLeft = "9px";
        ...
        document.getElementById("sezioni").style.width = "92%";
        document.getElementById("sezioni").style.marginLeft = "9px";
